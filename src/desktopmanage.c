...
/**	
 * desktopmanage dialog_close - the dialog was closed
 */	
static int desktopmanage_dialog_close(liqcell *self,liqcelleventargs *args, liqcell *context)
{
    desktopmanage_updateticks(self);
	return 0;
}
...
/**	
 * desktopmanage shown - first time on screen
 */	
static int desktopmanage_shown(liqcell *self,liqcelleventargs *args, liqcell *context)
{
    desktopmanage_updateticks(self);
	return 0;
}
