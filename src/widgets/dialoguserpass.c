...
#include <liqbase/md5.h>	// for hashing the password
		
		
//#####################################################################
//#####################################################################
//##################################################################### dialoguserpass :: by gary birkett
//#####################################################################
//#####################################################################
 ...
 */	
static int liqkeyboard_keypress(liqcell *self, liqcellkeyeventargs *args,liqcell *dialoguserpass)
{
	
	liqcell *frame1 = liqcell_child_lookup(dialoguserpass, "frame1");
		liqcell *item1 = liqcell_child_lookup(frame1, "item1");
	liqcell *liqkeyboard = liqcell_child_lookup(dialoguserpass, "liqkeyboard");
	liqcell *buttondel = liqcell_child_lookup(dialoguserpass, "buttondel");
	liqcell *buttonaccept = liqcell_child_lookup(dialoguserpass, "buttonaccept");	
	//
 ...
 */	
static int liqkeyboard_keyrelease(liqcell *self, liqcellkeyeventargs *args,liqcell *dialoguserpass)
{
	liqcell *frame1 = liqcell_child_lookup(dialoguserpass, "frame1");
		liqcell *item1 = liqcell_child_lookup(frame1, "item1");
	liqcell *liqkeyboard = liqcell_child_lookup(dialoguserpass, "liqkeyboard");
...
/**	
 * dialoguserpass.buttondel clicked
 */	
static int buttondel_click(liqcell *self,liqcelleventargs *args, liqcell *dialoguserpass)
{
	liqcell *frame1 = liqcell_child_lookup(dialoguserpass, "frame1");
		liqcell *item1 = liqcell_child_lookup(frame1, "item1");
	liqcell *liqkeyboard = liqcell_child_lookup(dialoguserpass, "liqkeyboard");
...
/**	
 * dialoguserpass.buttonaccept clicked
 */	
static int buttonaccept_click(liqcell *self,liqcelleventargs *args, liqcell *dialoguserpass)
{
	liqcell *frame1 = liqcell_child_lookup(dialoguserpass, "frame1");
		liqcell *item1 = liqcell_child_lookup(frame1, "item1");
	...
	char *userpassraw = liqcell_getcaption(item1);
	...
	liqapp_pref_setvalue("userpass",userpassmd5);
	liqapp_prefs_save();

	liqcell_propseti(dialoguserpass,"dialog_result",1);
	liqcell_setvisible(dialoguserpass,0);
	return 0;
}
...
/**	
 * dialoguserpass widget refresh, all params set, present yourself to the user.
 */	
static int dialoguserpass_refresh(liqcell *self,liqcelleventargs *args, liqcell *context)
{
...
/**	
 * dialoguserpass dialog_open - the user zoomed into the dialog
 */	
static int dialoguserpass_dialog_open(liqcell *self,liqcelleventargs *args, liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass dialog_close - the dialog was closed
 */	
static int dialoguserpass_dialog_close(liqcell *self,liqcelleventargs *args, liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass widget shown - occurs once per lifetime
 */	
static int dialoguserpass_shown(liqcell *self,liqcelleventargs *args, liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass mouse - occurs all the time as you stroke the screen
 */	
static int dialoguserpass_mouse(liqcell *self, liqcellmouseeventargs *args,liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass click - occurs when a short mouse stroke occured
 */	
static int dialoguserpass_click(liqcell *self, liqcelleventargs *args,liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass keypress - the user pressed a key
 */	
static int dialoguserpass_keypress(liqcell *self, liqcellkeyeventargs *args,liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass keyrelease - the user released a key
 */	
static int dialoguserpass_keyrelease(liqcell *self, liqcellkeyeventargs *args,liqcell *context)
{
	return 0;
}
/**	
 * dialoguserpass paint - being rendered.  use the vgraph held in args to do custom drawing at scale
 */	
//static int dialoguserpass_paint(liqcell *self, liqcellpainteventargs *args,liqcell *context)
//{
//	// big heavy event, use sparingly
//	return 0;
//}
/**	
 * dialoguserpass dynamic resizing
 */	
static int dialoguserpass_resize(liqcell *self,liqcelleventargs *args, liqcell *context)
{
...
/**	
 * dialoguserpass_child_test_seek this function shows how to access members
 */	
	  
static void dialoguserpass_child_test_seek(liqcell *self)
{	  
	liqcell *icon = liqcell_child_lookup(self, "icon");
	liqcell *title = liqcell_child_lookup(self, "title");
	liqcell *frame1 = liqcell_child_lookup(self, "frame1");
...
/**	
 * create a new dialoguserpass widget
 */	
liqcell *dialoguserpass_create()
{
	liqcell *self = liqcell_quickcreatewidget("dialoguserpass", "form", 800, 480);
	if(!self) {liqapp_log("liqcell error not create 'dialoguserpass'"); return NULL;  } 
	...
	liqcell_setcaption(title, "please enter your liqbase user password" );
	...
	liqcell_setcaption(frame1, "apologies for lack of * over password.  all passwords are hashed and never stored plaintext." );
	...
	liqcell_propsets(  buttonaccept, "backcolor", "rgb(0,100,0)" );
	...
	liqcell_handleradd_withcontext(self, "refresh", dialoguserpass_refresh ,self);
	liqcell_handleradd_withcontext(self, "shown", dialoguserpass_shown ,self);
	//liqcell_handleradd_withcontext(self, "resize", dialoguserpass_resize ,self);
	liqcell_handleradd_withcontext(self, "keypress", dialoguserpass_keypress,self );
	liqcell_handleradd_withcontext(self, "keyrelease", dialoguserpass_keyrelease ,self);
	liqcell_handleradd_withcontext(self, "mouse", dialoguserpass_mouse,self );
	liqcell_handleradd_withcontext(self, "click", dialoguserpass_click ,self);
	//liqcell_handleradd_withcontext(self, "paint", dialoguserpass_paint ,self); // use only if required, heavyweight
	liqcell_handleradd_withcontext(self, "dialog_open", dialoguserpass_dialog_open ,self);
	liqcell_handleradd_withcontext(self, "dialog_close", dialoguserpass_dialog_close ,self);
	return self;
}
