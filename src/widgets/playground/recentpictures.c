...
//#####################################################################
//#####################################################################
//##################################################################### recentpictures :: by gary birkett
//#####################################################################
//#####################################################################
...
//#####################################################################
	...
	static int recentpictures_filter(liqcell *self, liqcellfiltereventargs *args, void *context)
	{
	...
	static int recentpictures_refresh(liqcell *self, liqcelleventargs *args, void *context)
	{
	...
	static int recentpictures_resize(liqcell *self, liqcelleventargs *args, void *context)
	{
	...
	static int recentpictures_paint(liqcell *self, liqcellpainteventargs *args,liqcell *recentpictures)
	{
		liqcell *body = liqcell_child_lookup(self,"body");
...
liqcell *recentpictures_create()
{
	liqcell *self = liqcell_quickcreatewidget("recentpictures","form", 800,480);
	...
	if(self)
	{
		...
		liqcell_handleradd(self,    "refresh",   recentpictures_refresh);
		liqcell_handleradd(self,    "resize",   recentpictures_resize);
		liqcell_handleradd(self,    "filter",   recentpictures_filter);
		liqcell_handleradd(self,    "paint",   recentpictures_paint);
		recentpictures_resize(self,NULL,NULL);
