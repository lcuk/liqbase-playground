		...
		while( NULL != (dir_entry_p = readdir(dir_p)))
		{
			...
			else			if ( S_ISREG(statbuf.st_mode) )
			{
				  ...
				  )
				{
					...
					liqcell *c = liqcell_quickcreatevis(fn,   "song",   0,0,400,40    );
					//liqcell_propseti(c,"lockaspect",1);
					liqcell_propsets(c,"imagefilename","media/quickicons/sound.png");
					...
					liqcell_handleradd(c,    "click",   item_click);
						...
						//liqcell_propsets(  c, "textcolor", "rgb(0,0,0)" );
						//liqcell_propsets(  c, "backcolor", "rgb(0,0,60)" );
...
//#####################################################################
	...
	static int songlist_filter(liqcell *self, liqcellfiltereventargs *args, void *context)
	{
	...
	static int songlist_refresh(liqcell *self, liqcelleventargs *args, void *context)
	{
	...
	static int songlist_resize(liqcell *self, liqcelleventargs *args, void *context)
	{
	...
	static int songlist_paint(liqcell *self, liqcellpainteventargs *args,liqcell *songlist)
	{
		liqcell *body = liqcell_child_lookup(self,"body");
...
liqcell *songlist_create()
{
	liqcell *self = liqcell_quickcreatewidget("songlist","form", 800,480);
	...
	if(self)
	{
		...
		liqcell_handleradd(self,    "refresh",   songlist_refresh);
		liqcell_handleradd(self,    "resize",   songlist_resize);
		liqcell_handleradd(self,    "filter",   songlist_filter);
		liqcell_handleradd(self,    "paint",   songlist_paint);
		songlist_resize(self,NULL,NULL);
