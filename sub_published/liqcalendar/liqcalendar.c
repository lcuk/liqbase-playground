...
liqcell *liqcalendar_create()
{
	...
	if(self)
	{
		...
		liqcell *tbar = uitoolcol_create("tools","tools",
				...
				//uitoolitem_create( "delete", "delete",     "/usr/share/liqbase/liqcalendar/media/quickicons/gtk-remove.png",           toolitem_click,self),
				//uitoolitem_create( "add",    "add",        "/usr/share/liqbase/liqcalendar/media/quickicons/add.png",              toolitem_click,self),
				//uitoolitem_create( "edit", "edit",     "/usr/share/liqbase/liqcalendar/media/quickicons/package_graphics.png",           toolitem_click,self),
				//uitoolitem_create( "close",  "close",      "/usr/share/liqbase/liqcalendar/media/quickicons/gtk-close.png",    toolitem_click),
				//uitoolitem_create( "back",   "back",       "/usr/share/liqbase/liqcalendar/media/quickicons/back.png",              toolitem_click,self),
				NULL);
