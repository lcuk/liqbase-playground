...
liqcell *liqrecentapps_create()
{
	liqcell *self = liqcell_quickcreatewidget("liqrecentapps","form", 800,480);
	...
	if(self)
	{
		...
		liqcell_scan_folder_for_images(body,"media/maemo apps");
